...
public class DiscountEngineTests
{
    ...
    {
        var dm = new DiscountManager { PromoCode = "SAVE10", TotalAmount = 60.0m, CustomerType = 1 };
    ...
    {
        var dm = new DiscountManager { VisitCount = 120, CustomerType = 2, MembershipLevel = "Diamond", MonthsSinceMembership = 36, AverageSpend = 80m, ConsecutiveVisits = 15, LeftReview = true, ReviewStars = 5, ReferralCount = 5 };
